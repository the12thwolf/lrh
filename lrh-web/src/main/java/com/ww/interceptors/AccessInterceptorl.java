 ...
 */
public class AccessInterceptorl implements HandlerInterceptor {
    private final Logger logger = Logger.getLogger(AccessInterceptorl.class);
    @Resource
    ...
    public boolean preHandle(HttpServletRequest request,HttpServletResponse response,Object o)
            throws Exception {
        logger.info("拦截器运行11。。。,访问的地址:"+request.getRequestURL().toString()+"  ");
