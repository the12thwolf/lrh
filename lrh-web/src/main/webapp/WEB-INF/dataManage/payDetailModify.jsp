...
function getSubPayitemsByItemName(){
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">
            <form action="payDetail/modifyPayDetail" method="post" class="main_form" id="form1">
                <table>
                    <tr>
                        <td>
                <input type="hidden" name="payId" id="payId" value="${payDetail.payId}" />
                <span >项目名称&nbsp;&nbsp;</span>
                <select id="itemName" name="itemName" onchange="getSubPayitemsByItemName();">
                    <option value="${payDetail.itemName}">${payDetail.itemName}</option>
                </select>&nbsp;&nbsp;
                <span >用途&nbsp;&nbsp;</span>
                <select id="subitemName" name="subitemName">
                    <option value="${payDetail.subitemName}">${payDetail.subitemName}</option>
                </select>
                <span class="required">*</span>&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="button" value="&nbsp;修改&nbsp;" class="" onclick="getPayitems();">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <div class="input_info">
                                <span >金额(元):&nbsp;&nbsp;&nbsp;</span>
                                <input type="text" class="width150" name="payAmount" id="payAmount" value="${payDetail.payAmount}"" />
                                <span class="required">*</span>
                    ...
                    <select id="payPerson" name="payPerson">
                        <option value="${payDetail.payPerson}">${payDetail.payPerson}</option>
                    </select>
                    <span class="required">*</span>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="button" value="&nbsp;修改&nbsp;" class="" onclick="changePayPerson();">
                        </td>
                    </tr>
                    <%--<tr>
                        <td>
                <div class="input_info">
                    ...
                    <tr>
                        <td>
                            支出日期:
                            <input readonly class="layinput" name="payDate" id="payDate" value="${payDetail.payDate}">
                ...
                <div class="input_info">
                    <span >备注:&nbsp;&nbsp;&nbsp;</span>
                    <textarea name="contant" id="contant" cols="90" rows="5">${payDetail.contant}</textarea>
                ...
                <div class="input_info">
                    ...
                    <input type="hidden" name="itemNameOld" id="itemNameOld" value="${itemName}" />
                    <input type="hidden" name="subitemNameOld" id="subitemNameOld" value="${subitemName}" />
                    <input type="hidden" name="payPersonOld" id="payPersonOld" value="${payPersonOld}" />
                    <input type="hidden" name="payDateStartOld" id="payDateStartOld" value="${payDateStart}" />
                    <input type="hidden" name="payDateEndOld" id="payDateEndOld" value="${payDateEnd}" />
                </div>
