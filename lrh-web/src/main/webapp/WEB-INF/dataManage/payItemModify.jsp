...
<!--主要区域开始-->
<div id="main">
    <form action="dataManage/payItemModify" method="post" class="main_form" id="form1">
        <div class="text_info clearfix"><span>支出类型名称：</span></div>
        <div class="input_info">
            <input type="text" id="itemName" class="width300" name="itemName" value="${payItem.itemName}"/>
            <input id="itemId" type="hidden" name="itemId" value="${payItem.itemId}">
